...
export type Identity = { userId: string; organizationId: string; role: 'admin'|'manager'|'worker'; deviceId: string; sessionId: string };
...
export async function issueSession(client: PoolClient, identity: Omit<Identity,'sessionId'>) {
